...
1. **How to get scores?**  
   We feed query as well as response into reward model to attain scores. This means that each score of a token is highly dependent on priori tokens.  
...
2. **Carefully mask scores and logprobs**. TRL create attention mask by 3 process  
