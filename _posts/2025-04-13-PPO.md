...
This part we introduce some applications with PPO including Reinforcement Learning from
Human Feedback (RLHF)[[2]](#references) as well as Atari games.  
  
---  

### Reinforcement Learning from Human Feedback (RLHF)  
RLHF is introduced to further align an LLM to human values. In this part, we attempts to show the details of implementation of RLHF with PPO, including:  
...
During training, we sample data from buffer and update actor and critic model by PPO methods.  
